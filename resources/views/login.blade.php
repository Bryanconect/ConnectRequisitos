...
@if (auth()->check())
Login Efetuado com sucesso! Usuário: {{ auth()->user()->name }}   

</div> 

<div class="row col-md-12 mx-auto mt-4">
  <div class="row col-md-6 mx-auto border bg-light">
  <img src="{{ asset('assets/img/requisito.png') }}" />
<a class="btn btn-success" href="{{url("requisitos/inicio")}}">Requisitos</a>
  </div>
  <div class="row col-md-6 mx-auto border bg-light">
  <img src="{{ asset('assets/img/elicitacao.png') }}" />
<a class="btn btn-success" href="{{url("elicitacao/inicio")}}">Elicitação</a>
  </div>
</div>
