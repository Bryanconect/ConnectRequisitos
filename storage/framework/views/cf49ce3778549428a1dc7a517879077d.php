...
<table class="table text-center">
  ...
  <?php if($historias->status == 'Aberto' || $historias->status == 'Em Progresso'): ?>
  ...
  <?php echo method_field('PUT'); ?>
      ...
      <td>
        <a href="<?php echo e(url("requisitos/gestaohistoria/editarhistoria/$historias->id")); ?>">
          <button class="btn btn-success"> Editar </button>
        </a>
        <a href="<?php echo e(url("requisitos/gestaohistoria/homologarhistoria/$historias->id")); ?>">
          <button class="btn btn-primary"> Homologar </button>
        </a>
        <a href="<?php echo e(url("requisitos/gestaohistoria/cancelarhistoria/$historias->id")); ?>">
...
<?php echo $__env->make('templates.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\laravel\resources\views/indexgestaohistoria.blade.php ENDPATH**/ ?>