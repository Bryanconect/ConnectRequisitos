  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link" href="<?php echo e(url("elicitacao/inicio")); ?>">Elicitação de Requisitos</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="<?php echo e(url("requisitos/inicio")); ?>">Gestão de Requisitos</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="<?php echo e(url("relatorios")); ?>">Relatórios</a>
        </li>
      </ul>
      <form class="d-flex">
...
</html><?php /**PATH C:\xampp\ProjetoFinal\resources\views/templates/template.blade.php ENDPATH**/ ?>