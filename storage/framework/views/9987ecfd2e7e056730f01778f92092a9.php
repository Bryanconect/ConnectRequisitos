...
<div class="col-md-20 mx-auto col-lg-20  bg-light"> 


<div class="col-md-20 mx-auto col-lg-20 bg-light"> 

<?php if(auth()->check()): ?>
Login Efetuado com sucesso! Usuário: <?php echo e(auth()->user()->name); ?>   

</div> 

<div class="row col-md-12 mx-auto mt-4">
  <div class="row col-md-6 mx-auto border bg-light">
  <img src="<?php echo e(asset('assets/img/requisito.png')); ?>" />
<a class="btn btn-success" href="<?php echo e(url("requisitos/inicio")); ?>">Requisitos</a>
  </div>
  <div class="row col-md-6 mx-auto border bg-light">
  <img src="<?php echo e(asset('assets/img/elicitacao.png')); ?>" />
<a class="btn btn-success" href="<?php echo e(url("elicitacao/inicio")); ?>">Elicitação</a>
  </div>
</div>
...
<form class ="p-4 p-md-5 border bg-secondary"  action="<?php echo e(route('login.store')); ?>" method="post">
...
<a href="<?php echo e(url("/inicio")); ?>">
          <button class="btn btn-danger"> Voltar ao Inicio</button>
        </a> 
    <a href="<?php echo e(url("/novousuario")); ?>">
...
<script src="<?php echo e(url("assets/js/javascript2.js")); ?>">  </script>
...
<?php echo $__env->make('master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\ProjetoFinal\resources\views/login.blade.php ENDPATH**/ ?>