...
<form class ="p-3 p-md-5 border bg-secondary" name="formCad" id="formCad" action="<?php echo e(route('login.storeusuario')); ?>" method="post">
<h1 class="text-center">Solicitar Acesso</h1>
<div class="form-floating mt-4">  
<?php echo csrf_field(); ?>
  <input  class="form-control" maxLength="100" type="text" name="name" id="name" required>
  <label> Informe seu Nome: </label>
</div>
<div class="form-floating mt-4">  
  <input  class="form-control" maxLength="100" type="text" name="email" id="email" required>
  <label> Informe seu E-mail: </label>
</div>
<br>
<div class="form-floating"> 
  <input class="form-control" maxLength="100" type="password" name="senha" id="senha" required>
  <label> Informe sua futura Senha: </label>
  </div>
  <br>
...
<a href="<?php echo e(url("/login")); ?>">
          <button class="btn btn-danger"> Voltar ao Login </button>
        </a>
...
<?php echo $__env->make('master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\laravel\resources\views/createuser.blade.php ENDPATH**/ ?>